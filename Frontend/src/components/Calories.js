    ...
    <>
      ...
      <section className="calories-counter" id="calories-counter">
        ...
        <main className="calories" id="calories-counter-content">
          <h2 className="sub-heading">What are Calories?</h2>
          <p className="paragraph">
            Calories are units of energy that fuel our bodies. They are found in
            all foods and drinks except water. The amount of energy provided by
            food is measured in kilocalories (kcal) or simply calories. The
            average daily caloric intake varies based on age, gender, and
            activity level:
          </p>
          <ul className="list">
            <li>
            ...
            <li>
              <strong>Children:</strong> 1,200-1,800 calories/day, depending on
          ...
          <ul className="list">
            ...
            <li>
              <strong>Sources: </strong> Dairy products, legumes, nuts, seeds,
              Meat, fish, and eggs
            </li>
            <li>
          ...
          <p className="paragraph">
            ...
            classified into simple (sugars) and complex (starches and fibers)
            carbohydrates.
          </p>
          <ul className="list">
            <li>
        ...
        <ol className="list">
          ...
          <li>
            <strong>Vitamins and Minerals:</strong> Crucial for overall health;
